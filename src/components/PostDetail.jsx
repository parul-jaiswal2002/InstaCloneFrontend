...
const PostDetail = ({Item, toggleDetail}) => {
  ...
  const deletPost = (postId) => {
    if(window.confirm('Are you sure you want to delete this post?')) {
      fetch(`https://instaclonebackend-5yyd.onrender.com/post/deletePost/${postId}`, {
        method: 'DELETE',
        headers : {
  ...
  return (
    ...
    <div className="showComment">
            <div className="close-comment" onClick={() => toggleDetail()} >
        ...
        <div className="container">
            ...
            <div className="postDetails">
                ...
                <div className="card-header" style={{borderBottom : '1px solid #00000029'}}>
                    ...
                    <div className="deleteIcon" onClick={() => deletPost(Item._id)}>
